...
\begin{itemize}
    ...
    \item family: podemos elegir entre Bernoulli(), Binomial(), Gamma(), Normal(), Poisson() o NegativeBinomial() \val{Todavía no entiendo muy bien esto}
    \item link: \val{no entiendo muy bien a que se refiere esto, creo que está fuera del alcance de la tesis}
\end{itemize}
