...
Para las cantidades de datos, seleccioné al azar una muestra de 500, 5 mil, 50 mil y 500 mil observaciones del Censo. Hice un ajuste con cada muestra para cada fórmula de regresión. Es decir, para la regresión con la fórmula base, hay 4 tablas de resultados correspondientes a las 4 diferentes cantidades de observaciones. 
Al final, tengo 24 tablas de resultados con dos columnas. La primera columna es el ajuste hecho en Julia y la segunda es el ajuste hecho en R. Los resultados son exactamente iguales en todos los casos. 
